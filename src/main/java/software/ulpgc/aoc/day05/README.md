...
*   **SOLID**:
    ...
    *   **Open/Closed Principle (OCP - Principio de Abierto/Cerrado)**:
        *   Los tipos `ID` y `Range` encapsulan la semántica del dominio y no dependen de una regla concreta de validación. Si se introduce una nueva forma de combinar intervalos o una nueva regla de frescura, puede añadirse como una nueva estrategia sin alterar dominios existentes.
