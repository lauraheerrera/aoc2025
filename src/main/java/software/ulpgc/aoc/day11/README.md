...
*   **SOLID**:
    ...
    *   **Open/Closed Principle (OCP - Principio de Abierto/Cerrado)**:
        *   El grafo de dispositivos constituye el núcleo estable del dominio y su representación no depende de la forma en la que se resuelven los recorridos. La lógica de conteo de rutas se implementa actualmente mediante DFS con memoización, pero el diseño permite incorporar nuevas formas de cálculo sin modificar la estructura del grafo ni sus entidades asociadas, manteniendo así la estabilidad del modelo frente a la variación algorítmica.
