...
public class ManifoldTest {
    ...
    public void solve_example() {
        ...
        assertThat(PathCounter.of(manifold).countPaths()).isEqualTo(new BigInteger("40"));
    }

    @Test
    public void test_paths_initialization_and_access() {
        software.ulpgc.aoc.day07.b.model.Paths paths = software.ulpgc.aoc.day07.b.model.Paths.initial(3);
    ...
    public void test_paths_propagation_single_splitter() {
        software.ulpgc.aoc.day07.b.model.Paths paths = software.ulpgc.aoc.day07.b.model.Paths.initial(3);
        Row row = Row.from(".^.");
        software.ulpgc.aoc.day07.b.model.Paths nextPaths = software.ulpgc.aoc.day07.b.model.Paths.next(paths, row);
    ...
    public void test_manifold_paths_no_splitters() {
        Manifold manifold = Manifold.from(List.of(
                ...
                "...",
                "..."));
        assertThat(PathCounter.of(manifold).countPaths()).isEqualTo(BigInteger.ONE);
    }
    ...
    public void test_manifold_paths_one_splitter() {
        Manifold manifold = Manifold.from(List.of(
                ...
                ".^.",
                "..."));
        assertThat(PathCounter.of(manifold).countPaths()).isEqualTo(new BigInteger("2"));
    }
    ...
    public void test_manifold_paths_multiple_splitters() {
        Manifold manifold = Manifold.from(List.of(
                ...
                ".^.^.",
                "....."));
        assertThat(PathCounter.of(manifold).countPaths()).isEqualTo(new BigInteger("4"));
    }
}
